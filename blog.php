            ...
            <div class="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            <h3 class="ltn__blog-title"><a href="blog-details.html">The Most Inspiring Interior Design Of 2023</a></h3>
                        </div>
                    </div>
                </div>
                <!-- Blog Item -->
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            <h3 class="ltn__blog-title"><a href="blog-details.html">Renovating a modern Living Room 2023</a></h3>
                        </div>
                    </div>
                </div>
                <!-- Blog Item -->
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            <h3 class="ltn__blog-title"><a href="blog-details.html">7 home trends that will shape your house in 2023</a></h3>
                        </div>
                    </div>
                </div>
            </div>
