                ...
                <div class="col-lg-12">
                    <div class="ltn__our-history-inner">
                        <div class="ltn__tab-menu text-uppercase">
                            <div class="nav">
                                <a data-bs-toggle="tab" href="#liton_tab_2_1">1990</a>
                                <a class="active show" data-bs-toggle="tab" href="#liton_tab_2_2">2000</a>
                                <a data-bs-toggle="tab" href="#liton_tab_2_3">2010</a>
                                <a data-bs-toggle="tab" href="#liton_tab_2_4">2020</a>
                                <a data-bs-toggle="tab" href="#liton_tab_2_5">2023</a>
                            </div>
                        </div>
    ...
    <div class="ltn__about-us-area pt-120--- pb-90 mt--30">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-left">
                        <img src="img/others/13.png" width="800"height="500" alt="About Us Image">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-1--- mb-20">
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-7 ltn__feature-item-7-color-white">
                        <div class="ltn__feature-icon-title">
                            ...
                            <h3><a href="#">The Perfect Residency</a></h3>
                        </div>
                        <div class="ltn__feature-info">
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-7 ltn__feature-item-7-color-white">
                        <div class="ltn__feature-icon-title">
                            ...
                            <h3><a href="#">Global Architect Experts</a></h3>
                        </div>
                        <div class="ltn__feature-info">
                            <p>Lorem ipsum dolor sit ame it, consectetur adipisicing elit, sed do eiusmod te mp or incididunt ut labore.</p>
                        </div>
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-7 ltn__feature-item-7-color-white">
                        <div class="ltn__feature-icon-title">
                            ...
                            <h3><a href="#">Built-in Storage Cupboards</a></h3>
                        </div>
                        <div class="ltn__feature-info">
                            <p>Lorem ipsum dolor sit ame it, consectetur adipisicing elit, sed do eiusmod te mp or incididunt ut labore.</p>
                        </div>
